...
class Block:
    def __init__(self, master):
        ...
        self.listbox_frame = tk.LabelFrame(master, text='Матрица', bg=COLOR, width=830, height=290)
        ...
        self.result_frame = tk.LabelFrame(master, bg=COLOR, text='Результат', width=530, height=300)
        self.result_frame.grid_propagate(False)
        self.res_states = tk.Listbox(self.result_frame, selectmode=tk.SINGLE, width=18, bg=COLUMNS_COLOR, height=1)
        self.res_probability = tk.Listbox(self.result_frame, selectmode=tk.SINGLE, width=18, bg=COLUMNS_COLOR, height=1)
        self.res_time = tk.Listbox(self.result_frame, selectmode=tk.SINGLE, width=18, bg=COLUMNS_COLOR, height=1)
